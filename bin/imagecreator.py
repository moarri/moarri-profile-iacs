...
import sys
import os
from iacs_profile.profile_parser import parse_caaml_file
from PIL import ImageColor
from iacs_graphics.profile_image import ProfileGraphicsImage
...
if __name__ == '__main__':
    ...
    print(snow_profile)
    profileImage = ProfileGraphicsImage(snow_profile, 700, 620, 1000, 1000, 200, 200)
